...
Hydrogen 的国际化分两层：**路由 + API 上下文**（代码层，已完成）和**翻译内容**（运营层，本文档）。代码层见 [06-context-session-i18n.md](./06-context-session-i18n.md)

## 1. 前置条件

| 步骤 | 路径 | 状态 |
|------|------|------|
| Markets 激活目标市场 | Settings → Markets → Asia（含 Japan） | ✅ Active |
...
- 见 [12-deployment-i18n-research.md](./12-deployment-i18n-research.md) Bug #1 说明
